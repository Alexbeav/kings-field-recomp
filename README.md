# King's Field Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/kings-field-recomp/total)](https://github.com/Alexbeav/kings-field-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/kings-field-recomp/latest/total)](https://github.com/Alexbeav/kings-field-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/kings-field-recomp)](https://github.com/Alexbeav/kings-field-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **King's Field** built on
[psxrecomp](https://github.com/Alexbeav/psxrecomp) and
[recomp-ui](https://github.com/mstan/recomp-ui).

A native recompilation setup host for King's Field.
...
Zip prefix for CI artifacts: `King-s-Field-Recomp`.
