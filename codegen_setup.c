...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "kings-field-",
    .project_root_env = "KINGS_FIELD_RECOMP_PROJECT_ROOT",
    .build_dir_env = "KINGS_FIELD_RECOMP_BUILD_DIR",
    .force_setup_env = "KINGS_FIELD_RECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/PSX.EXE_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "King_s_Field_Recompiled",
    .prepare_note =
