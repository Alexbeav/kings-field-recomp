...
#
# Writes: dist/King-s-Field-Recomp-<VERSION>-<artifact-tag>.zip
set -euo pipefail
...
exec bash "${PACKAGER}" \
  ...
  --zip-prefix King-s-Field-Recomp \
  --exe-name King_s_Field_Recompiled \
  --display-name "King's Field Recompiled" \
